  ...
  return (
    <section className="py-24" style={{ background: "#fff" }}>
      <div className="max-w-[1400px] mx-auto px-8 md:px-16">
        ...
        {/* Widget card */}
        <div
          className="max-w-[860px] mx-auto rounded-2xl overflow-hidden flex flex-col md:flex-row"
          style={{
            ...
            <div className="w-full max-w-[340px]">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button className="text-gray-400 hover:text-gray-700 text-lg leading-none">&lsaquo;</button>
                  <button className="text-gray-400 hover:text-gray-700 text-lg leading-none">&rsaquo;</button>
                </div>
              </div>
              <div
