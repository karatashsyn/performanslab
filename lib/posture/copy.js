...
export const FOCUS_CARDS = {
  shoulder_tilt_deg: {
    ...
    recommendations: ["Göğüs kaslarını düzenli olarak esnet"],
  },
  hip_tilt_deg: {
    id: "lumbar_lordosis",
    ...
    recommendations: ["Kalça ve core stabilite çalışmalarına yer ver"],
  },
  head_forward_ratio: {
    id: "head_forward",
    ...
    recommendations: ["Boyun ve üst sırt mobilite egzersizleri ekle"],
  },
  spine_deviation_ratio: {
    ...
    recommendations: ["Simetrik yükleme ve yan core çalışmalarına ağırlık ver"],
  },
  knee_asymmetry_deg: {
    id: "knee_asymmetry",
    ...
    recommendations: ["Tek bacak (unilateral) çalışmalara öncelik ver"],
  },
  neck_tilt_deg: {
    id: "neck_tilt",
    ...
    recommendations: ["Ekran yüksekliğini göz hizasına ayarla ve boyunu düzenli esnet"],
  },
};
